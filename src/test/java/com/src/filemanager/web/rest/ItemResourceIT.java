...
class ItemResourceIT {
    ...
    private static final ItemType DEFAULT_TYPE = ItemType.SPACE;
    private static final ItemType UPDATED_TYPE = ItemType.FOLDER;
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().type(DEFAULT_TYPE).name(DEFAULT_NAME);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().type(UPDATED_TYPE).name(UPDATED_NAME);
        return item;
    }
    ...
    void putExistingItem() throws Exception {
        ...
        updatedItem.type(UPDATED_TYPE).name(UPDATED_NAME);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.type(UPDATED_TYPE).name(UPDATED_NAME);
