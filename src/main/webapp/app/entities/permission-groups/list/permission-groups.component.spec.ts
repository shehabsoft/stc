...
describe('PermissionGroups Management Component', () => {
  let comp: PermissionGroupsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'permission-groups', component: PermissionGroupsComponent }]),
      ...
      .overrideTemplate(PermissionGroupsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.permissionGroups?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to permissionGroupsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPermissionGroupsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPermissionGroupsIdentifier).toHaveBeenCalledWith(entity);
